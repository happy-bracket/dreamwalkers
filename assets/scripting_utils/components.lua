...
prismatic_component = comp_package .. "PrismaticComponent"
...
prismatic_class = luajava.bindClass(prismatic_component)
...
prismatic_mapper = cm_factory:getFor(prismatic_class)
